...
class __$$IdleCopyWithImpl<T, $Res>
    extends _$CoursesStateCopyWithImpl<T, $Res, _$Idle<T>>
...
abstract class Idle<T> implements CoursesState<T> {
...
class __$$LoadingCopyWithImpl<T, $Res>
    extends _$CoursesStateCopyWithImpl<T, $Res, _$Loading<T>>
...
abstract class Loading<T> implements CoursesState<T> {
...
class __$$SuccessCopyWithImpl<T, $Res>
    extends _$CoursesStateCopyWithImpl<T, $Res, _$Success<T>>
...
class _$Success<T> implements Success<T> {
  ...
  @override
  String toString() {
    return 'CoursesState<$T>.success(data: $data)';
  }
...
abstract class Success<T> implements CoursesState<T> {
...
class __$$ErrorCopyWithImpl<T, $Res>
    extends _$CoursesStateCopyWithImpl<T, $Res, _$Error<T>>
...
class _$Error<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'CoursesState<$T>.error(networkExceptions: $networkExceptions)';
  }
...
abstract class Error<T> implements CoursesState<T> {
