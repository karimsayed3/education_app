...
/// @nodoc
abstract class $FeatureStateCopyWith<T, $Res> {
  factory $FeatureStateCopyWith(
          FeatureState<T> value, $Res Function(FeatureState<T>) then) =
      _$FeatureStateCopyWithImpl<T, $Res, FeatureState<T>>;
}

/// @nodoc
class _$FeatureStateCopyWithImpl<T, $Res, $Val extends FeatureState<T>>
    implements $FeatureStateCopyWith<T, $Res> {
...
class __$$IdleCopyWithImpl<T, $Res>
    extends _$FeatureStateCopyWithImpl<T, $Res, _$Idle<T>>
...
abstract class Idle<T> implements FeatureState<T> {
...
class __$$LoadingCopyWithImpl<T, $Res>
    extends _$FeatureStateCopyWithImpl<T, $Res, _$Loading<T>>
...
abstract class Loading<T> implements FeatureState<T> {
...
class __$$SuccessCopyWithImpl<T, $Res>
    extends _$FeatureStateCopyWithImpl<T, $Res, _$Success<T>>
...
class _$Success<T> implements Success<T> {
  ...
  @override
  String toString() {
    return 'FeatureState<$T>.success(data: $data)';
  }
...
abstract class Success<T> implements FeatureState<T> {
...
class __$$ErrorCopyWithImpl<T, $Res>
    extends _$FeatureStateCopyWithImpl<T, $Res, _$Error<T>>
...
class _$Error<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'FeatureState<$T>.error(networkExceptions: $networkExceptions)';
  }
...
abstract class Error<T> implements FeatureState<T> {
